...
| **조임 (Strained)** | 입술을 모으고 수직 간격을 좁게 한 상태 | 높은 음역 (G4–B4) |

6. 인식된 음표가 스피커를 통해 자동으로 재생됩니다.

### 음표 맵

| 입술 상태 \ 밸브 | 누름 없음 | 앞 (1번) | 중간 (2번) | 뒤 (3번) | 중간+앞 | 뒤+앞 | 뒤+중간 |
|---|---|---|---|---|---|---|---|
| **닫힘 (Closed)** | C4 | E4 | F#4 | F4 | D#4 | D4 | E4 |
| **조임 (Strained)** | G4 | A4 | B4 | A#4 | G#4 | G4 | A4 |
